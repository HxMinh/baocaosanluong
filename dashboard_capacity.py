...
def authenticate_google_sheets():
    ...
    try:
        ...
        # Method 1: Try LOCAL JSON file FIRST (for local development)
        ...
        # Method 2: Try base64-encoded credentials (for Streamlit Cloud)
        try:
            ...
            pass  # No base64 secrets, try next method
        
        # Method 3: Try regular TOML format (for Streamlit Cloud)
        try:
            ...
            pass  # No TOML secrets
            
        # No credentials found
        st.error("❌ Lỗi: Không tìm thấy file JSON cục bộ hoặc Secrets trên Streamlit Cloud.")
        st.info("💡 Local: Đặt file JSON credentials vào thư mục dự án.")
        st.info("💡 Cloud: Vào Settings -> Secrets và dán cấu hình TOML.")
        return None
